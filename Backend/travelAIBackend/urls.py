...
from .views import addUserToDatabase, removeFlight, removeHotel, accountExists, addToItinerary,addHotels, addFlights, getFlightsFromDB, getHotelsFromDB, getAttractionsFromDB, addTravelPref, getRecommendations
