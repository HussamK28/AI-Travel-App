...
from .views import addUserToDatabase, accountExists, addToItinerary,addHotels, addFlights, getFlightsFromDB, getHotelsFromDB, getAttractionsFromDB, addTravelPref, getRecommendations
